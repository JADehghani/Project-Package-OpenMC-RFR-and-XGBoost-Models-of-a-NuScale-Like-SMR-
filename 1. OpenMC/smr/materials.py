...
from openmc.data import water_density
...
mats['H2O'].add_s_alpha_beta('c_H_in_H2O')
...
aB10_bsg = wB10_bsg * M_bsg / atomic_mass('B10')
aB11_bsg = wB11_bsg * M_bsg / atomic_mass('B11')
