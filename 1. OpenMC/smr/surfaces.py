...
surfs['rod grid box'] = -openmc.model.RectangularPrism(rod_grid_side, rod_grid_side)

# Rectangular prisms for lattice grid sleeves
surfs['lat grid box inner'] = -openmc.model.RectangularPrism(17.*pin_pitch, 17.*pin_pitch)
surfs['lat grid box outer'] = -openmc.model.RectangularPrism(grid_strap_side, grid_strap_side)
