...
def core_geometry(ring_radii, num_axial, depleted):
    ...
    universes[2, 4] = assembly['Assembly (1.6%) CR D']
    ...
    universes[3, 3] = assembly['Assembly (1.6%) CR D']
    universes[3, 4] = assembly['Assembly (1.6%) CR D']
    universes[3, 5] = assembly['Assembly (1.6%) CR D']
    ...
    universes[4, 2] = assembly['Assembly (1.6%) CR D']
    universes[4, 3] = assembly['Assembly (1.6%) CR D']
    universes[4, 4] = assembly['Assembly (2.4%) CR D']
    universes[4, 5] = assembly['Assembly (1.6%) CR D']
    universes[4, 6] = assembly['Assembly (1.6%) CR D']
    ...
    universes[5, 3] = assembly['Assembly (1.6%) CR D']
    universes[5, 4] = assembly['Assembly (1.6%) CR D']
    universes[5, 5] = assembly['Assembly (1.6%) CR D']
    ...
    universes[6, 4] = assembly['Assembly (1.6%) CR D']
